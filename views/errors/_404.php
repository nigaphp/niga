...
<div class="container">
  ...
  <small>Create a route for your <a href="/">home page?</a> <code>bin/niga make:make-home-page</code></small>
</div>
<?php else: ?>
<div class="container">
    ...
    <p>You can use the following command <span><code>bin/niga make:make-home-page</code></span> to create a route for your / home page</p>
</div>
<?php endif ?>
